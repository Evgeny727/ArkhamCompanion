...
@Composable
fun CardsFiltersIllustratorsScreen(
    ...
    val filteredIllustrators = remember(illustrators, searchQuery) {
    ...
    Column(
        ...
        ArkhamSearchBox(
            ...
            searchPlaceholder = stringResource(R.string.search_for_illustrators)
        )

        AnimatedVisibility(illustrators.isEmpty()) {
            Column(
        ...
        LazyColumn(
            ...
            items(
                items = filteredIllustrators,
                key = { it },
                contentType = { "illustrator" }
            ) { illustrator ->

                ArkhamCheckboxButton(
                    title = illustrator,
                    isSelected = illustrator in selectedIllustrators,
                    modifier = Modifier.padding(horizontal = 8.dp)
                ) { onIllustratorChange(illustrator) }
