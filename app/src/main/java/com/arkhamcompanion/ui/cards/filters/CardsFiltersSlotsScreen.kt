...
fun CardsFiltersSlotsScreen(
    ...
    val filteredSlots = remember(slotCodes, resources, searchQuery) {
    ...
    Column(
        ...
        ArkhamSearchBox(
            ...
            searchPlaceholder = stringResource(R.string.search_for_slots)
        )

        AnimatedVisibility(slotCodes.isEmpty()) {
            Column(
